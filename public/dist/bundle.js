...
document.addEventListener('DOMContentLoaded', function () {
  try {
    // tabs for auth
    materialize_css__WEBPACK_IMPORTED_MODULE_0___default().Tabs.init(document.querySelectorAll(".tabs")); // beauty select view

    materialize_css__WEBPACK_IMPORTED_MODULE_0___default().FormSelect.init(document.querySelectorAll('select')); // sidebar for mobile

    materialize_css__WEBPACK_IMPORTED_MODULE_0___default().Sidenav.init(document.querySelectorAll('.sidenav')); // flash events
