import { CATEGORY, USER_PASSWORD, SONG_NAME, SONG_TEXT } from './validation';
...
export const SHORT_PASSWORD = `Пароль має містити мінімум ${USER_PASSWORD.MIN} символів`;
export const LONG_PASSWORD = `Пароль має містити максимум ${USER_PASSWORD.MAX} символів`;
