...
import { COLLECTIONS, DATABASE_NAME } from './constants/index.js';
...
app.use('/source', (req, res, next) => res.status(403).end('403 Forbidden'));
...
const start = async () => {
  try {
    ...
    await mongoose.connect(process.env.MONGODB_URL, { dbName: DATABASE_NAME });
